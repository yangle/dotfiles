...
nnoremap <buffer> <silent> <S-F9> <Esc>:w<CR>:!g++ -g -std=c++11 -Wall -Wextra -o z % -lm && ./z<CR>
nnoremap <buffer> <silent> <F9> <Esc>:w<CR>:silent !gnome-terminal-run "g++ -g -std=c++11 -Wall -Wextra -o z % -lm && ./z"<CR>:redraw!<CR>
