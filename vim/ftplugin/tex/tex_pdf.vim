...
function! <SID>BuildTexPdf(view_results, ...)
    ...
    if filereadable("Makefile")
        ...
        if executable(l:special_tex_compiler)
            ...
            " setlocal makeprg=mkdir\ \-p\ tmp;pdflatex\ \-file\-line\-error\ \-interaction=nonstopmode\ \-output\-directory\ tmp\ $*\\\|\ grep\ \-P\ ':\\d{1,5}:\ ';cp\ tmp/*.pdf\ .
            setlocal makeprg=mypdflatexmk\ $*
            setlocal errorformat=%f:%l:\ %m
            silent make %
        endif
